...
CREATE UNIQUE INDEX "UQ_ESTADO" ON "Experiencia" ("id_partido");
...
COMMENT ON TABLE "Guia" IS 'CHK_NIVEL: nivel IN (''basico'', ''intermedio'', ''experto'')
';
...
ALTER TABLE "Experiencia" ADD FOREIGN KEY ("id_partido") REFERENCES "PARTIDO" ("id_partido") DEFERRABLE INITIALLY IMMEDIATE;
